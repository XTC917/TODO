...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get initialTimelineReminderTitle => '🔔 设置提醒：务必前往设置>通知, 打开自启动与电池无限制';
  ...
  @override
  String get settingsBackgroundPermission => '后台运行与自启动';

  @override
  String get autostartPermissionHint =>
      '划掉后台后，提醒与专注计时可能失效。请按下方步骤开启自启动，并将电池设为「无限制」。';

  @override
  String get requestAutostartPermission => '前往开启自启动';

  @override
  String get openBackgroundSettings => '打开相关系统设置';

  @override
  String get autostartOpenResultDirect => '已打开系统设置页，请按上方步骤完成设置。';

  @override
  String get autostartOpenResultAppInfo => '已打开应用详情页，请在电池/自启动等选项中允许后台运行。';

  @override
  String get autostartOpenResultFailed => '无法自动跳转，请按上方步骤手动前往系统设置。';

  @override
  String get autostartManualGuideXiaomi =>
      '小米 / 红米 / POCO 手动设置：\n1. 打开「设置」→「应用设置」→「应用管理」，找到 JUJU日常\n2. 开启「自启动」，省电策略设为「无限制」\n3. 或在「手机管家」→「应用管理」→「自启动管理」中开启本应用';

  @override
  String get autostartManualGuideHuawei =>
      '华为 / 荣耀 手动设置：\n1. 打开「设置」→「应用和服务」→「应用启动管理」\n2. 找到 JUJU日常，关闭自动管理，并开启允许自启动、关联启动、后台活动\n3. 在应用详情中将电池设为「不受限制」';

  @override
  String get autostartManualGuideOppo =>
      'OPPO / 一加 / realme 手动设置：\n1. 打开「设置」→「应用」→「应用管理」，找到 JUJU日常\n2. 进入「耗电管理 / 电池」，选择「允许后台运行 / 不限制」\n3. 在「权限管理」→「自启动」中开启本应用';

  @override
  String get autostartManualGuideVivo =>
      'vivo / iQOO 手动设置：\n1. 打开「设置」→「应用与权限」→「权限管理」→「自启动」\n2. 找到 JUJU日常 并开启\n3. 在应用详情中将后台耗电设为「允许后台高耗电 / 不限制」';
  ...
  String get autostartManualGuideGeneric =>
      '通用手动设置：\n1. 打开系统「设置」→「应用」，找到 JUJU日常\n2. 确认通知权限已开启\n3. 在「电池 / 省电」中设为「无限制 / 不优化」\n4. 如有「自启动」「允许后台活动」请一并开启\n\n可在设置顶栏搜索「自启动」或「电池优化」快速定位。';
